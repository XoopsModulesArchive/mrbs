...
// $Id: language.inc 939 2008-10-17 12:20:25Z jberanek $
...
$locale = $default_language_tokens;	//xoops

//echo $locale.' local <br/>';
...

	{
...

		{
...

			{
				...
				setlocale(LC_ALL, $windows_locale);	//xoops

				//       $locale_warning = "Server failed to set locale to		//xoops

				//\"".$lang_map_windows[strtolower($locale)]."\" (Windows)";	//xoops
