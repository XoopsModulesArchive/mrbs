...
// $Id: mrbs.css.php 1011 2009-02-06 12:47:24Z jberanek $
...
include "Themes/".$xoopsModuleConfig['theme'];//xoops - blueteen
...
$month_cell_scrolling = $xoopsModuleConfig['month_cell_scrolling']; //xoops - blueteen-jobrazo
...
.dwm_main th {font-size: small; font-weight: normal; vertical-align: top; padding: 0 2px 0 2px;
    ...
    /*background-color: <?php echo $header_back_color ?>;*/ /*xoops - blueteen*/
