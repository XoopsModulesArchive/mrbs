<?php
$modulefolder=<<<contentend
#
# MySQL MRBS table creation script
#
# $Id: tables.my.sql 798 2008-04-13 19:59:24Z jberanek $
#
# Notes:
...
CREATE TABLE %modulename%_entry
(
  id          int NOT NULL auto_increment,
...
CREATE TABLE %modulename%_repeat
(
  id          int NOT NULL auto_increment,
  start_time  int DEFAULT '0' NOT NULL,
  end_time    int DEFAULT '0' NOT NULL,
